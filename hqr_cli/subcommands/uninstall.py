"""``hqr uninstall`` subcommand parser.
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall HQ Runtime Agent",
        description="Remove HQ Runtime Agent from your system. Can keep configs/data for reinstall.",
    )
