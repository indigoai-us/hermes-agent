...
The main() function in hqr_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `hqr -c model`
...
def _build_parser():
    """Build a minimal replica of the hqr top-level parser."""
