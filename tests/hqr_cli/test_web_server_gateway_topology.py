...
class TestStatusEndpointTopology:
    ...
    def _setup_client(self, monkeypatch, _isolate_hqr_home):
        try:
    ...
    def test_profile_names_and_mode_public_when_auth_gated(self, monkeypatch):
        ...
        # HQ Runtime Cloud Portal reads /api/status over the network (a gated bind)
        ...
        try:
            ...
            # alongside hqr_home / gateway_pid.
            assert "gateways" not in data
            assert "hqr_home" not in data
