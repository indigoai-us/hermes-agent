...
def _profile_user_agent() -> str:
    """Return a ``hqr-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from hqr_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"hqr-cli/{_ver}"
    except Exception:
        return "hqr-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # hqr-cli UA so the catalog endpoint is reachable.
