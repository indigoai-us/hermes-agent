"""Vertex AI (Google Cloud) adapter for HQ Runtime Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows HQ Runtime to use Gemini models via Google Cloud with
...
# who installed plain `hqr-agent` and only later selected a Gemini model.
try:
