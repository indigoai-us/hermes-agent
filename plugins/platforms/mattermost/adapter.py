...
required — uses aiohttp which is already a HQ Runtime dependency.
...
def interactive_setup() -> None:
    ...
    ``hqr_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where HQ Runtime delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # hqr_cli/setup.py::_setup_mattermost function.
