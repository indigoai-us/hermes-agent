...
The unit tests in tests/hqr_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned hqr-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/hqr")
from hqr_cli.service_manager import S6ServiceManager
