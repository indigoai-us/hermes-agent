...
DEFAULT_DATASETS = [
    ...
    "NousResearch/hqr-agent-megascience-sft1",
    "NousResearch/Hqr-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Hqr-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-hqr-agent"
]
