"""
Cron job scheduling system for HQ Runtime Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    hqr gateway install    # Install as a user service
    sudo hqr gateway install --system  # Linux servers: boot-time system service
    hqr gateway            # Or run in foreground
