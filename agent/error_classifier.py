...
# ``data:`` field before HQ Runtime receives a completion chunk.  Keeping this
...
# case: a stream dies mid-response and HQ Runtime persists a content-less
...
def classify_api_error(
    ...
    *,
    ...
    # hqr_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from hqr_cli.plugins import get_plugin_error_classification
