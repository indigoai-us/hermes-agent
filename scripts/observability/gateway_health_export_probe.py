...
def main() -> None:
    ...
    hqr_home = Path(tempfile.mkdtemp(prefix="hqr-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "hqr-gateway-smoke",
    ...
    print(json.dumps({"hqr_home": str(hqr_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
