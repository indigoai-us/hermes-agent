...
version: 1.0.1
author: Joe Rinaldi Johnson (joerj123), HQ Runtime Agent
license: MIT
...
| Telegram (HQ Runtime Agent + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
