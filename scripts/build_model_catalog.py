#!/usr/bin/env python3
"""Build the HQ Runtime Model Catalog — a centralized JSON manifest of curated models.
...
HQ Runtime CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a HQ Runtime release.
...
# Ensure HQR_HOME is set for imports that touch it at module level.
os.environ.setdefault("HQR_HOME", os.path.join(os.path.expanduser("~"), ".hqr"))

from hqr_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model HQ Runtime '
