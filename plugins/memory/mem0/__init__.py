...
Configuration
-------------
Secret (lives in $HQR_HOME/.env or the environment):
...
Behavioral settings (live in $HQR_HOME/mem0.json, set via `hqr memory
setup`):
  ...
  agent_id           — Agent identifier (default: hqr)
...
def _load_config() -> dict:
    """Load config from env vars, with $HQR_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "hqr"),
        "oss": {},
    }
    ...
    config_path = get_hqr_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, hqr_home):
        """Write config to $HQR_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $HQR_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "hqr")
