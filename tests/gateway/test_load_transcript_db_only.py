...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.hqr/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at hqr_state import time, before pytest's HQR_HOME monkeypatch
    fires — the autouse fixture's HQR_HOME override doesn't help here.)
    """
    import hqr_state
