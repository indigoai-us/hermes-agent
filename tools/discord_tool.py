...
Only included in the hqr-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Hqr-Agent (https://github.com/NousResearch/hermes-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_hqr_home() / "cache" / "discord_capabilities.json"
