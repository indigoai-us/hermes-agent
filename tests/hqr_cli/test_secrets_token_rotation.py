"""Tests for `hqr secrets bitwarden token` / `hqr secrets onepassword token`.
...
from hqr_cli import onepassword_secrets_cli as op_cli
from hqr_cli import secrets_cli as bw_cli
