...
# When the user hasn't picked a reasoning effort, HQ Runtime passes
...
# ON at this effort — matching the "medium (default)" that HQ Runtime' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map HQ Runtime' effort vocabulary onto Solar's accepted set. xhigh/max/
