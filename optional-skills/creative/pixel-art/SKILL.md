...
import sys
import os
sys.path.insert(0, os.path.expanduser("~/.hqr/skills/creative/pixel-art/scripts"))
...
```bash
cd ~/.hqr/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — HQ Runtime installs package this)
