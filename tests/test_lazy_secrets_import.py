"""Regression test: hqr update must not load cryptography eagerly."""
...
assert 'hqr_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running hqr update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so hqr_cli is importable,
...
import hqr_cli.main
from hqr_cli.update_cmd import _cmd_update_check
