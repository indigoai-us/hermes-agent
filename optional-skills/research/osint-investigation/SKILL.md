...
author: HQ Runtime Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT)
license: MIT
metadata:
  hqr:
...
# $HQR_OSINT_CACHE/icij/ (default: ~/.cache/hqr-osint/icij/).
...
# Set HQR_OSINT_UA=your-app/1.0 (your@email) to identify yourself
