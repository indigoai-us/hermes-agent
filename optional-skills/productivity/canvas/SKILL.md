...
4. Name the token (e.g., "HQ Runtime Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${HQR_HOME:-~/.hqr}/.env`:
...
```bash
CANVAS="python $HQR_HOME/skills/productivity/canvas/scripts/canvas_api.py"
