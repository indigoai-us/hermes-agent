...
the contract that subsequent turns echo it back; combined with how HQ Runtime
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; HQ Runtime remaps
the retired IDs in ``hqr_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave HQ Runtime, so they are not listed here.
    """
