"""HQ Runtime middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "hqr.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "hqr.middleware.v1"
...
def apply_llm_request_middleware(
    ...
    **context: Any,
    ...
    provider kwargs before HQ Runtime sends them.
    """
