...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your HQ Runtime session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show HQ Runtime session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running HQ Runtime agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update HQ Runtime Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the HQ Runtime gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a HQ Runtime session in it",
