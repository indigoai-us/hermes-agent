"""
Skills configuration for HQ Runtime Agent.
`hqr skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.hqr/config.yaml under:
...
from hqr_cli.config import cfg_get, load_config, save_config
from hqr_cli.colors import Colors, color
from hqr_cli.platforms import PLATFORMS as _PLATFORMS
