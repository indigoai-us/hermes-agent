"""Session <-> workspace grouping key (hqr_state.workspace_key).

The key is what `hqr sessions list --workspace` groups/filters on. It is a
...
from hqr_state import workspace_key
