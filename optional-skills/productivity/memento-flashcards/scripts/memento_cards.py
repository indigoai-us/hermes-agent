...
Data file: $HQR_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_HQR_HOME = Path(os.environ.get("HQR_HOME", Path.home() / ".hqr"))
DATA_DIR = _HQR_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
