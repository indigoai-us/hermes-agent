"""
HQ Runtime CLI - Unified command-line interface for HQ Runtime Agent.

Provides subcommands for:
- hqr chat          - Interactive chat (same as ./hqr)
- hqr gateway       - Run gateway in foreground
- hqr gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `hqr setup` on a fresh Pi.
    ...
    hqr_cli/stdio.py::configure_windows_stdio() runs later from the entry
