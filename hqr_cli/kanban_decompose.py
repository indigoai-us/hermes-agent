...
Invoked by ``hqr kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the HQ Runtime Agent board.
...
def _profile_author() -> str:
    """Mirror of ``hqr_cli.kanban._profile_author``."""
    return (
