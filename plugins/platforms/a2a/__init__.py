"""
A2A (Agent-to-Agent) plugin for HQ Runtime Agent.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes HQ Runtime as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`hqr gateway setup` flow for A2A."""
    ...
    print_info("Expose HQ Runtime as an A2A-discoverable agent and call other A2A agents.")
