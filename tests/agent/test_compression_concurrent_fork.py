...
Damien's incident (Discord, 2026-05-28): a long HQ Runtime session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``hqr_state`` module, whose ``SessionDB``
...
_NominalSessionDBImpostor.__module__ = "hqr_state"
