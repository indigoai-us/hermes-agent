...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`hqr_cli.slash_exec.EXECUTORS`, and
...
from hqr_cli.commands import COMMAND_REGISTRY, resolve_command
from hqr_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
