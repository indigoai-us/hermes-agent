#!/usr/bin/env python3
"""
SWE Runner with HQ Runtime Trajectory Format

A runner that uses Hqr-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Hqr-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Hqr-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in HQ Runtime format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Hqr-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Hqr-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with HQ Runtime Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Hqr-Agent's built-in execution environments
    and outputs trajectories in Hqr-Agent format.
    """
    ...
    def _convert_to_hqr_format(
        ...
        """
        Convert internal message format to HQ Runtime trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to HQ Runtime trajectory format
        trajectory = self._convert_to_hqr_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with HQ Runtime trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with HQ Runtime Trajectory Format")
    print("=" * 60)
