...
Trust levels:
  - builtin:   Ships with HQ Runtime. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hqr/\.env|\~/\.hqr/\.env',
     "hqr_env_access", "critical", "exfiltration",
     "directly references HQ Runtime secrets file"),
    ...
    (r'\.hqr/config\.yaml|\.hqr/SOUL\.md',
     "hqr_config_mod", "critical", "persistence",
     "references HQ Runtime configuration files directly"),
...
# scan. `.skillignore` is the HQ Runtime-native name; `.clawhubignore` is honored
