"""Tests for the shared byte formatter (hqr_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from hqr_cli.backup import _format_size as backup
    from hqr_cli.checkpoints import _fmt_bytes as checkpoints
    from hqr_cli.doctor import _human_bytes as doctor
