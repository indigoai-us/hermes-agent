...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), HQ Runtime Agent
license: MIT
...
Helper script path: `~/.hqr/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.hqr/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.hqr/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.hqr/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
