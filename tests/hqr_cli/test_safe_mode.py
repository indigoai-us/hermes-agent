"""Tests for `hqr chat --safe-mode` isolation."""
...
_VARS = ("HQR_SAFE_MODE", "HQR_IGNORE_USER_CONFIG", "HQR_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["HQR_SAFE_MODE"] == "1"
        assert os.environ["HQR_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["HQR_IGNORE_RULES"] == "1"
        return True
