...
metadata:
  hqr:
    ...
    related_skills: [obsidian, hqr-agent, arxiv]
---
...
HQ Runtime Agent via the native MCP client. This is the preferred
...
Then configure HQ Runtime Agent to connect via HTTP:
