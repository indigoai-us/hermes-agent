"""Tests for `_can_open_graphical_browser()` in hqr_cli.auth.

Guards the fix for the May 2026 report where `hqr auth add xai-oauth`
...
from hqr_cli.auth import _can_open_graphical_browser
