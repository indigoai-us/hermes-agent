...
Single-user HQ Runtime memory store plugin.
"""
...
class MemoryStore:
    ...
    def __init__(
        ...
        if db_path is None:
            ...
            db_path = str(get_hqr_home() / "memory_store.db")
    ...
    def _init_db(self) -> None:
        ...
        # gracefully on NFS/SMB/FUSE-mounted HQR_HOME (same issue as
        # state.db / kanban.db — see hqr_state._WAL_INCOMPAT_MARKERS).
