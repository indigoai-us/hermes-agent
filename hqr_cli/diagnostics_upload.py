"""Client for uploading ``hqr debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``hqr debug share``.
...
NAS_BASE = os.environ.get(
    "HQR_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "hqr-agent/debug-share"
