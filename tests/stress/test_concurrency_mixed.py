...
def worker_loop(worker_id: int, hqr_home: str, result_file: str) -> None:
...
def reclaimer_loop(hqr_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="hqr_mixed_stress_")
    print(f"HQR_HOME = {home}")
