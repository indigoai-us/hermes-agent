...
version: 4.0.0
author: 0xbyt4, HQ Runtime Agent
license: MIT
dependencies: []
...
```bash
python -m pyfiglet "HQR" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=HQR&font=Slant" | boxes -d stone
```
