...
Registry of record: `hqr_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore HQ Runtime config+state snapshots (CLI)
...
/update                  Update HQ Runtime to latest
