"""Core NeMo Relay adapter for HQ Runtime tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the HQ Runtime tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous HQ Runtime Relay tool execution cannot run on an active event-loop thread"
    )
