...
Used by ``hqr profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``hqr_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the HQ Runtime Agent kanban board.
...
Rules:
  ...
  - Never write "HQ Runtime Agent profile" or other meta-narration.
