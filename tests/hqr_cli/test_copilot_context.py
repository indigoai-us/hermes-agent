...
class TestGetCopilotModelContext:
    ...
    @patch("hqr_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("hqr_cli.models._urlopen_model_catalog_request")
    ...
    @patch("hqr_cli.models.fetch_github_model_catalog", return_value=[])
