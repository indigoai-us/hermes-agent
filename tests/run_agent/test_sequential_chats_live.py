...
AlexKucera reported on Discord (2026-04-16) that after ``hqr update`` pulled
...
Opt-in — not part of default CI:
    HQR_LIVE_TESTS=1 pytest tests/run_agent/test_sequential_chats_live.py -v

Requires ``OPENROUTER_API_KEY`` to be set (or sourced via ~/.hqr/.env).
"""
