...
Design notes / invariants (same contract as ``hqr_cli/goals.py``):
...
- This module has zero hard dependency on ``cli.HqrCLI``, the gateway
...
def _get_session_db() -> Optional[Any]:
    """One SessionDB per HQR_HOME (same pattern as goals._get_session_db)."""
    try:
