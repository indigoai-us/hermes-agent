...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> HQ Runtime gateway adapter.

    Each inbound phone number gets its own HQ Runtime session (multi-tenant).
...
# static dict in hqr_cli/gateway.py, and the _send_sms dispatch in
