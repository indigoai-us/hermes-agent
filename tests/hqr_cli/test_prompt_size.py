"""Tests for the ``hqr prompt-size`` diagnostic (issue #34667)."""
...
from hqr_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(hqr_home, memory_text="", user_text=""):
    mem_dir = hqr_home / "memories"
...
def _seed_skill(hqr_home, name, description):
    skill_dir = hqr_home / "skills" / "demo" / name
