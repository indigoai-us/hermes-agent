...
# ---------------------------------------------------------------------------
# Thread-safe cache entry update (hqr_cli/models.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Parallel prefetch (hqr_cli/model_switch.py)
# ---------------------------------------------------------------------------
...
class TestPrefetchProviderModelsParallel:
    ...
    def test_skips_all_fresh_entries(self, monkeypatch):
        ...
        from hqr_cli.model_switch import _prefetch_provider_models_parallel
        ...
        with patch("hqr_cli.models._load_provider_models_cache", return_value=fresh_cache), \
             patch("hqr_cli.models._credential_fingerprint", return_value="fp"), \
             patch("hqr_cli.models.cached_provider_model_ids") as fetch:
    ...
    def test_fetches_only_stale_entries(self, monkeypatch):
        ...
        with patch("hqr_cli.models._load_provider_models_cache", return_value=cache), \
             patch("hqr_cli.models._credential_fingerprint", return_value="fp_f"), \
             patch("hqr_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("hqr_cli.models.update_provider_cache_entry"):
    ...
    def test_fetches_in_parallel(self, monkeypatch):
        ...
        with patch("hqr_cli.models._load_provider_models_cache", return_value={}), \
             patch("hqr_cli.models._credential_fingerprint", return_value="fp"), \
             patch("hqr_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("hqr_cli.models.update_provider_cache_entry"):
    ...
    def test_empty_list_is_noop(self):
        ...
        with patch("hqr_cli.models.cached_provider_model_ids") as fetch:
...
class TestPrefetchIntegration:
    ...
    def test_prefetch_called_with_more_than_3_providers(self):
        ...
        from hqr_cli import model_switch
