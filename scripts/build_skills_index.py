#!/usr/bin/env python3
"""Build the HQ Runtime Skills Index — a centralized JSON catalog of all skills.
...
`hqr skills search/install` can use it without hitting the GitHub API.
...
# Ensure HQR_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building HQ Runtime Skills Index...", flush=True)
