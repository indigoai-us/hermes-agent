...
def _state_dir() -> Path:
    ...
    # Default: $HQR_HOME/watcher-state/, falling back to ~/.hqr/watcher-state/.
    hqr_home = os.environ.get("HQR_HOME") or str(Path.home() / ".hqr")
    return Path(hqr_home) / "watcher-state"
