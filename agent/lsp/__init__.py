"""Language Server Protocol (LSP) integration for HQ Runtime Agent.

HQ Runtime runs full language servers (pyright, gopls, rust-analyzer,
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``hqr chat`` exit would leak pyright processes that
