...
decomposition campaign (``~/.hqr/plans/god-file-decomposition.md``, Phase 1
...
def finalize_turn(
    ...
    *,
    ...
    if iteration_limit_fallback:
        ...
        _kanban_task = os.environ.get("HQR_KANBAN_TASK")
        if _kanban_task:
    ...
    result = {
        ...
        # billing audits by callers like `hqr -z --usage-file`.
        "service_tier": (
    ...
    if failed and str(_turn_exit_reason) == "session_persistence_failed":
        result["error"] = final_response or (
            ...
            "health (`hqr doctor`), then send your message again"
        )
