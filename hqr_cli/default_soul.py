"""Default SOUL.md template seeded into HQR_HOME on first run."""

DEFAULT_SOUL_MD = (
    "You are HQ Runtime Agent, an intelligent AI assistant created by Nous Research. "
...
_LEGACY_TEMPLATE_SOULS = (
    (
        ...
        "Edit this to customize how HQ Runtime communicates with you.\n"
        "\n"
        "Examples:\n"
