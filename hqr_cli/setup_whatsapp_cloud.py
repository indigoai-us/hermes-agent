...
Entry point: ``hqr whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``hqr_cli/main.py``).
...
HQ Runtime gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures HQ Runtime to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  HQ Runtime needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the HQ Runtime gateway in another terminal:")
    print("         hqr gateway")
    print()
