"""Tests for _setup_feishu() in hqr_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("hqr_cli.config.save_env_value", side_effect=mock_save), \
         patch("hqr_cli.config.get_env_value", side_effect=mock_get), \
         patch("hqr_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("hqr_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("hqr_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("hqr_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("hqr_cli.cli_output.print_header"), \
         patch("hqr_cli.cli_output.print_info"), \
         patch("hqr_cli.cli_output.print_success"), \
         patch("hqr_cli.cli_output.print_warning"), \
         patch("hqr_cli.cli_output.print_error"), \
