...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (hqr_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_hqr_overlays():
    """hqr_cli.providers.get_provider("vertex") backs
