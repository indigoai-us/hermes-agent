"""Tests for `hqr curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated HQR_HOME with real agent-created skills on disk."""
    home = tmp_path / ".hqr"
    skills = home / "skills"
    ...
    from hqr_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import hqr_cli.curator as curator_cli
