"""Tests for ``hqr approvals suggest`` (hqr_cli/approvals_suggest.py).

Approval history in HQ Runtime is implied, not ledgered: the session DB
...
from hqr_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
