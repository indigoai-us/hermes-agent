...
Config: ~/.hqr/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.hqr/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_hqr_home()`` helper (HQR_HOME-aware and
...
RULES_FILE = get_hqr_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_hqr_home() / "feishu_comment_pairing.json"
