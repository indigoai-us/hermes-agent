#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from HQ Runtime logs.
...
With no LOGFILE, reads ``$HQR_HOME/logs/agent.log`` (default ~/.hqr).
...
def default_log() -> Path:
    home = os.environ.get("HQR_HOME") or str(Path.home() / ".hqr")
