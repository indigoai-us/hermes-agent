...
version: 0.1.0
author: Mibay (Mibayy), HQ Runtime Agent
license: MIT
...
```
SCRIPT=~/.hqr/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.hqr/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
