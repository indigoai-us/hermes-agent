...
When a provider returns a non-OK status on a *streaming* request, HQ Runtime reads
...
streams"), generalized to cover HQ Runtime's three streaming error-body sites
