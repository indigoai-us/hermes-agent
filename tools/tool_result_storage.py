...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/hqr-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/hqr-results/{tool_use_id}.txt on Termux)
...
STORAGE_DIR = "/tmp/hqr-results"
HEREDOC_MARKER = "HQR_PERSIST_EOF"
...
def _heredoc_marker(content: str) -> str:
    ...
    return f"HQR_PERSIST_{uuid.uuid4().hex[:8]}"
