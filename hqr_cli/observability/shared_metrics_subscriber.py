"""Relay subscriber for the persisted HQ Runtime shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated HQ Runtime counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the HQ Runtime shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
