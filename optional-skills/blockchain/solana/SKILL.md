...
version: 0.2.0
author: Deniz Alagoz (gizdusum), enhanced by HQ Runtime Agent
license: MIT
...
Helper script path: ~/.hqr/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.hqr/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.hqr/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.hqr/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.hqr/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.hqr/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.hqr/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
