...
from hqr_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/hqr_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("hqr_cli.lifecycle.invoke_hook")
@patch("hqr_cli.lifecycle.finalize_session")
